	...
	return(
		<div className='pt1 bt bb vh-40 w-100 pres'>
			<div className='h-50 w-100 mt0 pt0'>
				<p className='pres-title'>Welcome to my website !</p>
			...
			<div className='h-50 w-100 center'>
				<img alt='' src={logoHtml}  className='logo pr5'/>
				<img alt='' src={logoCSS}  className='logo pr5'/>
				<img alt='' src={logoJS}  className='logo pr5'/>
				<img alt='' src={logoReact}  className='logo pr5'/>
			</div>
		</div>
	)
}
